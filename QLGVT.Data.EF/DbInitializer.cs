    ...
    public class DbInitializer
    {
        ...
        public async Task Seed()
        {
            ...
            if (_context.Functions.Count() == 0)
            {
                ...
                {
                    new Function() {Id = "QUANLYDONVI",Name = "Quản lý đơn vị",ParentId = null,SortOrder = 2,Status = Status.Active,URL = "/",IconCss = "fa-chevron-down"},
                    new Function() {Id = "TUYEN",Name = "Tuyến",ParentId = "QUANLYDONVI",SortOrder =1,Status = Status.Active,URL = "/admin/tuyen/index",IconCss = "fa-chevron-down"},
                    new Function() {Id = "BENXE",Name = "Bến xe",ParentId = "QUANLYDONVI",SortOrder = 2,Status = Status.Active,URL = "/admin/benxe/index",IconCss = "fa-chevron-down"},
                    new Function() {Id = "DONVI",Name = "Đơn vị vận tải",ParentId = "QUANLYDONVI",SortOrder = 3,Status = Status.Active,URL = "/admin/donvivantai/index",IconCss = "fa-chevron-down"},

                    new Function() {Id = "QUANLYBANGIA",Name = "Quản lý giá",ParentId = null,SortOrder = 3,Status = Status.Active,URL = "/",IconCss = "fa-money"},
                    new Function() {Id = "BANGIA",Name = "Bảng Giá",ParentId = "QUANLYBANGIA",SortOrder =1,Status = Status.Active,URL = "/admin/kekhaigiarate/index",IconCss = "fa-money"},
                    new Function() {Id = "KEKHAIGIA",Name = "Kê khai giá",ParentId = "QUANLYBANGIA",SortOrder = 2,Status = Status.Active,URL = "/admin/kekhaigia/index",IconCss = "fa-money"},
                    ...
                    new Function() {Id = "CONTENT",Name = "Content",ParentId = null,SortOrder = 4,Status = Status.Active,URL = "/",IconCss = "fa-table"  },
                    new Function() {Id = "BLOG",Name = "Blog",ParentId = "CONTENT",SortOrder = 1,Status = Status.Active,URL = "/admin/blog/index",IconCss = "fa-table"  },
                    new Function() {Id = "UTILITY",Name = "Utilities",ParentId = null,SortOrder = 5,Status = Status.Active,URL = "/",IconCss = "fa-clone"  },
                    ...
                    new Function() {Id = "REPORT",Name = "Report",ParentId = null,SortOrder = 6,Status = Status.Active,URL = "/",IconCss = "fa-bar-chart-o"  },
